...
/**
 * Write a buffer to the function 0 of the SDIO target.
 *
 * @param hTarget Handle to target object.
 * @param address SDIO address.
 * @param data Send buffer.
 ...
 * @return True if successful, otherwise FALSE.
 */
cb_boolean cbTARGET_f0_write(cbTARGET_Handle *hTarget, cb_uint32 address, cb_uint8* data, cb_uint32 dataSize);

/**
 * Read from the function 0 of the SDIO target.
 *
 * @param hTarget Handle to target object.
 * @param address SDIO address.
 * @param data Receive buffer.
 ...
 * @return TRUE if successful, otherwise FALSE.
 */
cb_boolean cbTARGET_f0_read(cbTARGET_Handle *hTarget, cb_uint32 address, cb_uint8 *data, cb_uint32 dataSize);
