...
typedef enum {
    ...
    cbHW_RESET_REASON_FACTORY_RESET
}cbHW_ResetReason;
...
void cbHW_enableBkpSRAMClk(void);
void cbHW_disableBkpSRAMClk(void);
...
/**
* Save factory reset mode in persistent memory
* @return None
*/
void cbHW_configureForFactoryResetAtStartup(void);

void cbHW_rebootCrash(void);
